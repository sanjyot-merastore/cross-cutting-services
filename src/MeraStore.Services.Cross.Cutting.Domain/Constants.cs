...
{
  public const string ServiceName = "cross-cutting-service";
  ...
  public static class Logging
  {
    public static class Elasticsearch
    {
      ...
      public const string DefaultIndexFormat = "service-logs-";
      public const string InfraIndexFormat = "infra-logs-";
      public const string EntityFrameworkCoreIndexFormat = "ef-logs-";
    }
