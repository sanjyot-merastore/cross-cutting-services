...
public class ClientBuilder
{
  ...
  public ClientBuilder()
  {
    ...
    _httpClientBuilder = _services.AddHttpClient<LoggingServiceClient>();
  ...
  public LoggingServiceClient Build()
  {
    _httpClientBuilder.AddPolicyHandler(_resiliencePolicy);
    var provider = _services.BuildServiceProvider();
    return provider.GetRequiredService<LoggingServiceClient>();
  }
